...
def fill(text, cfg, plain_text=False):
    ...
    be inserted without HTML entity encoding. plain_text preserves the configured
    EMAIL spelling only; other substitutions retain their existing escaping.
    """
